...
#install_dir = one dir up

install_dir = os.path.normpath(os.path.join(os.path.dirname(__file__), '..'))
data_dir = os.path.join(install_dir, 'mdid-data')

MEDIA_URL = '/static/'
ADMIN_MEDIA_PREFIX = '/static/admin/'

MEDIA_ROOT = os.path.join(install_dir, 'rooibos', 'static')
SCRATCH_DIR = os.path.join(install_dir, 'mdid-scratch')
AUTO_STORAGE_DIR = os.path.join(install_dir, 'mdid-data', 'auto-storage')


# contrib.compressor settings
# Needed to enable compression JS and CSS files
COMPRESS = True
# try the 1024 * 1024 at some point
UPLOAD_LIMIT = 5242880

# dependency connections - solr & memcache must be in place for mdid3 to work

SOLR_URL = 'http://127.0.0.1:8983/solr/'
CACHE_BACKEND = 'memcached://127.0.0.1:11211/'

# open office must be in place for powerpoint import & export

OPEN_OFFICE_PATH = '/opt/openoffice.org3/program'

GEARMAN_SERVERS = ['127.0.0.1']



# admin emails (for tracebacks when DEBUG = False)
ADMINS = (
...
# moved up with all the path & dir examples
#ADMIN_MEDIA_PREFIX = '/static/admin/'
